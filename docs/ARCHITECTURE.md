...
| `user_settings`    | Per-user filtering/scoring overrides.                                                  | `user_id`, `uses_defaults`, `expert_skills[]`, `secondary_skills[]`, `bonus_skills[]`, `job_age_days`, `pipeline_visa/local/global`, `seniority_allow_mid`, `gemini_filter_prompt`, `scoring_weights` (jsonb), `score_denominator`, `excluded_keywords[]`, `blacklisted_locations[]`, `required_keywords[]`, `email_alerts_enabled` |
...
| `ats_companies`    | Source-of-truth company list scraped by the cron job.                                  | `id`, `name`, `ats`, `slug`, `country`, `country_flag`, `city`, `pipeline_visa/local/global`, `is_active`                                                                                                                                                                                                                           |
