...
const COMPANIES: ATSConfig[] = [
  ...
  { ats: "greenhouse",      name: "Fawry",           slug: "fawry",              country: COUNTRY, countryFlag: FLAG, city: "Cairo" },
  { ats: "workable",        name: "Moneyfellows",    slug: "moneyfellows",       country: COUNTRY, countryFlag: FLAG, city: "Cairo" },
  { ats: "lever",           name: "Amenli",          slug: "amenli",             country: COUNTRY, countryFlag: FLAG, city: "Cairo" },
  ...
  { ats: "greenhouse",      name: "Swvl",            slug: "swvl",               country: COUNTRY, countryFlag: FLAG, city: "Cairo" },
  { ats: "lever",           name: "Jumia",           slug: "jumia",              country: COUNTRY, countryFlag: FLAG, city: "Cairo" },
  ...
  { ats: "greenhouse",      name: "Elmenus",         slug: "elmenus",            country: COUNTRY, countryFlag: FLAG, city: "Cairo" },
  ...
  { ats: "lever",           name: "Integrant",       slug: "integrant",          country: COUNTRY, countryFlag: FLAG, city: "Cairo" },
  { ats: "workable",        name: "Atomica",         slug: "atomica",            country: COUNTRY, countryFlag: FLAG, city: "Cairo" },

  // ── Cannot scrape (server-side / down) ────────────────────────────────
  // Objects, Trianglz, SoftXpert (Zoho), Enozom, Innova → headless browser only
];
