...
export const SKILL_REGISTRY: Record<string, { aliases: string[]; category: string }> = {
  React: { aliases: ["react.js", "reactjs"], category: "frontend" },
  "Next.js": { aliases: ["nextjs", "next js"], category: "frontend" },
  Vue: { aliases: ["vue.js", "vuejs", "vue 3"], category: "frontend" },
  Angular: { aliases: ["angularjs", "angular 2"], category: "frontend" },
  Svelte: { aliases: ["sveltekit"], category: "frontend" },
  Remix: { aliases: [], category: "frontend" },
  Astro: { aliases: [], category: "frontend" },
  "React Native": { aliases: ["react-native"], category: "mobile" },
  TypeScript: { aliases: ["ts", "tsx"], category: "language" },
  JavaScript: { aliases: ["js", "es6", "es2015", "ecmascript"], category: "language" },
  Python: { aliases: [], category: "language" },
  Go: { aliases: ["golang"], category: "language" },
  Rust: { aliases: [], category: "language" },
  Java: { aliases: [], category: "language" },
  Tailwind: { aliases: ["tailwindcss", "tailwind css"], category: "styling" },
  ...
  Sass: { aliases: ["scss"], category: "styling" },
  "Radix UI": { aliases: ["radix"], category: "styling" },
  shadcn: { aliases: ["shadcn/ui"], category: "styling" },
  Redux: { aliases: ["redux toolkit", "rtk"], category: "state" },
  Zustand: { aliases: [], category: "state" },
  Jotai: { aliases: [], category: "state" },
  MobX: { aliases: [], category: "state" },
  "React Query": {
    aliases: ["react-query", "tanstack query", "@tanstack/react-query"],
    category: "state",
  },
  SWR: { aliases: [], category: "state" },
  XState: { aliases: [], category: "state" },
  ...
  "Testing Library": { aliases: ["@testing-library"], category: "testing" },
  ...
  Turborepo: { aliases: [], category: "tooling" },
  "Node.js": { aliases: ["nodejs", "node js"], category: "backend" },
  GraphQL: { aliases: ["gql"], category: "backend" },
  REST: { aliases: ["restful", "rest api"], category: "backend" },
  tRPC: { aliases: [], category: "backend" },
  NestJS: { aliases: ["nest.js"], category: "backend" },
  Express: { aliases: ["express.js"], category: "backend" },
  Prisma: { aliases: [], category: "backend" },
  Supabase: { aliases: [], category: "backend" },
  Firebase: { aliases: [], category: "backend" },
  AWS: { aliases: ["amazon web services"], category: "cloud" },
  GCP: { aliases: ["google cloud"], category: "cloud" },
  Azure: { aliases: [], category: "cloud" },
  Docker: { aliases: [], category: "cloud" },
  Kubernetes: { aliases: ["k8s"], category: "cloud" },
  "CI/CD": { aliases: ["github actions", "gitlab ci"], category: "cloud" },
  PostgreSQL: { aliases: ["postgres"], category: "database" },
  MongoDB: { aliases: ["mongo"], category: "database" },
  Redis: { aliases: [], category: "database" },
  Accessibility: { aliases: ["a11y", "wcag", "aria"], category: "concept" },
  i18n: { aliases: ["internationalization", "l10n"], category: "concept" },
  "Micro-frontends": { aliases: ["microfrontend", "micro frontend"], category: "concept" },
  "Web Performance": { aliases: ["core web vitals", "cwv", "lighthouse"], category: "concept" },
  WebSockets: { aliases: ["websocket", "ws", "socket.io"], category: "concept" },
  Figma: { aliases: [], category: "design" },
  Agile: { aliases: ["scrum", "kanban", "sprint"], category: "process" },
};
